...
void loop() {
  ...
  // Set LED RGB ke kuning
  rgb_led.setPixelColor(0, rgb_led.Color(255, 255, 0));  // Set LED pertama ke warna kuning (merah+hijau)
  rgb_led.show();  // Memperbarui warna LED
  delay(1000);      // Tunggu 1000 ms atau 1 detik

  // Set LED RGB ke cyan/biru toska
  rgb_led.setPixelColor(0, rgb_led.Color(0, 255, 255));  // Set LED pertama ke warna biru toska/cyan (hijau+biru)
  rgb_led.show();  // Memperbarui warna LED
  delay(1000);      // Tunggu 1000 ms atau 1 detik

  // Set LED RGB ke ungu
  rgb_led.setPixelColor(0, rgb_led.Color(255, 0, 255));  // Set LED pertama ke warna ungu (merah+biru)
  rgb_led.show();  // Memperbarui warna LED
  delay(1000);      // Tunggu 1000 ms atau 1 detik  

  // Set LED RGB ke putih
  rgb_led.setPixelColor(0, rgb_led.Color(255, 255, 255));  // Set LED pertama ke warna putih (merah+hijau+biru)
  rgb_led.show();  // Memperbarui warna LED
  delay(1000);      // Tunggu 1000 ms atau 1 detik

  // Set LED RGB ke MATI
  rgb_led.setPixelColor(0, rgb_led.Color(0, 0, 0));  // Set LED pertama MATI RGB=0
  rgb_led.show();  // Memperbarui warna LED
  delay(1000);      // Tunggu 1000 ms atau 1 detik
}
